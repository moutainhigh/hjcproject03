...
public class Constants {
	 ...
	 * 普通网关，融宝：3
	 */
	public static final int RB_AY = 3;
	/**
	 * 普通网关，融宝：4
	 */
	public static final int RB_ST = 4;
	...
	public static final String YYSJ_URL = Play.configuration.getProperty("yysj_url");			//怡园数据url
	public static final String YYSJ_APPKEY = Play.configuration.getProperty("yysj_appkey");		//怡园数据加密key
	...
	public static final int ELEVN = 11;
	public static final int TWEL = 12;
	public static final int THRTEEN = 13;
	...
	public static final int S_SAN_BID = 5; // 散标
	public static final int S_HUO_BID = 7; // 活标

	public static final boolean IS_AGENCY = true; // 合作机构
	public static final boolean NOT_IS_AGENCY = false; // 非合作机构
	
	public static final boolean IS_REGULAR = true; // 活标
	public static final boolean IS_NOT_REGULAR = false; // 散标
	...
	public static final int MAX_TIXIAN_VALUE = 500000; // 提现上限
	...
	public static final int BBIN_NOT_ENOUGH = -1001; // 发标保证金不够
...
//	public static final int PROPORTIONATELY_REWARD = 2; // 按比例奖励
	...
	/**定期标提前结束**/
	public static final int BID_STOP_INADVANCE = 30;// 定期标提前结束
	
	/*** 体验金金额*/
	public static final double BBIN_ACCOUNT=Double.parseDouble(Play.configuration.getProperty("bbin.account"));
	...
	public static final int BID_REGULAR = 700; //定期标。
	/* 账单催收 */
	...
	public static final int HOME_BID_COUNT = 2; // 首页借款标限制
	public static final int HOME_DEBT_COUNT = 4; // 首页债权限制
...
//	public static final String NEWS_DETAIL_PAGE = "新闻资讯详情";
	...
	public static final String RECHARGE_PC = "3"; // pc充值
	 ...
	 * 每天返息描述
	 */
	public static final String DESCRIPTION = "返还当天所得利息";
	/**
	 * 最后一次返息描述
	 */
	public static final String DESCRIPTION_LAST = "还款期限已到返还剩余利息";
