...
public class SDKServiceLocator extends org.apache.axis.client.Service implements sms.ymrt.sdkhttp.SDKService {
...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    	 ...
    	 private java.lang.String SDKService_address =Play.configuration.getProperty("YMRT.WS.uri");
    ...
    public sms.ymrt.sdkhttp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            sms.ymrt.sdkhttp.SDKServiceBindingStub _stub = new sms.ymrt.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (sms.ymrt.sdkhttp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                sms.ymrt.sdkhttp.SDKServiceBindingStub _stub = new sms.ymrt.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
