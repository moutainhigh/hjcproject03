...
public class v_bill_repayment_record extends Model {
	...
	public double real_current_pay_amount;
	public String title;
	...
	public v_bill_repayment_record( double current_pay_amount, double real_current_pay_amount, String title, int overdue_mark
			, int status, Date real_repayment_time, Date repayment_time){
		this.title = title;
		this.current_pay_amount = current_pay_amount;
		this.real_current_pay_amount = real_current_pay_amount;
