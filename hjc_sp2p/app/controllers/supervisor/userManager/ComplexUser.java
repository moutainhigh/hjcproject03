...
public class ComplexUser extends SupervisorController {

	/**
	 * 复合会员
	 */
	public static void complexUser(){
		...
		PageBean<v_user_complex_info> page = User.queryComplexUserBySupervisor(name, email, beginTime, endTime, key, orderType, 
