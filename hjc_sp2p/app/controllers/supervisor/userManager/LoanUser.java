...
public class LoanUser extends SupervisorController {

	/**
	 * 借款会员
	 */
	public static void loanUser(){
		String statusType = params.get("statusType");
		...
		PageBean<v_user_loan_info> page = User.queryLoanUserBySupervisor(statusType,name,email, beginTime, endTime,
				key, orderType, curPage, pageSize, error);
