...
public class VIPUser extends SupervisorController {
	...
	public static void vipUser(){
		...
		PageBean<v_user_vip_info> page = User.queryVipUserBySupervisor(name, email, beginTime, endTime, key, orderType, 
