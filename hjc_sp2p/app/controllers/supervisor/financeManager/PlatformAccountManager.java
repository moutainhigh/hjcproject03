...
public class PlatformAccountManager extends SupervisorController {
	...
	public static void offSingleDeal(String payNumber){
		...
		if(user_recharge.payment_gateway_id == Constants.RB_AY){
			//融宝网关
			User.rbShSingleAY(payNumber,user_recharge,error);
			
		}
		if(user_recharge.payment_gateway_id == Constants.RB_ST){
			//融宝快捷
			User.rbShSingle(payNumber,user_recharge,error);
