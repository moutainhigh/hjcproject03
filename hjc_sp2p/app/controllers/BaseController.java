...
public class BaseController extends Controller {
	...
	@Before(unless={"front.account.LoginAndRegisterAction.setCode","Application.images","front.account.LoginAndRegisterAction.getImg","front.account.LoginAndRegisterAction.logining","supervisor.webContentManager.NewsManageAction.editContent"})
	protected static void injectionInterceptor() throws Exception {
		Request request = Request.current.get();
		Logger.debug("正在执行ation请求命令:%s",request.action);
